...
export default function ProContent() {
  return (
    <div className='w-full bg-[#FBFCFF] relative p-10 lg:p-16 '> 
    ...
    <div className='bg-[#FBFCFF] container mx-auto'>
        <div className='w-44 lg:w-60 font-bold lg:p-10 absolute z-10'>
            <h1 className='text-7xl lg:text-7xl text-gray-300 '>Different From Others</h1>
        </div>
        <div className='w-full flex flex-wrap lg:flex-nowrap'>
            <div className='w-full lg:w-3/12 flex flex-cols-2 lg:flex-col z-20'>
