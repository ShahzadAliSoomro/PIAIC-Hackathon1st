...
export default function ProContent() {
  return (
    ...
    <div className=' flex text-black font-extrabold absolute -top-14 lg:-right-36'>
        <h2 className='text-3xl lg:text-5xl w-full lg:w-9/12 container mx-auto'>Unique and Authentic Vintage Designer Jewellery</h2>
    </div>
    <div className='bg-[#FBFCFF] container mx-auto'>
        <div className='w-full lg:w-60 font-bold p-10 absolute z-10'>
            <h1 className='text-5xl lg:text-7xl text-gray-300 '>Different From Others</h1>
        </div>
        <div className='w-full flex flex-wrap lg:flex-nowrap'>
            <div className='w-full lg:w-3/12 flex flex-col z-20'>
            ...
            <div className='w-full lg:w-6/12 flex'>
                <div className='flex justify-center items-center gap-5 flex-wrap'>
                    ...
                    <div className='flex flex-col space-y-7'>
                      <p className='text-gray-700 text-lg text-justify'>This piece is ethically crafted in our small family-owned workshop in Peru with unmatched attention to detail and care. The Natural color is the actual natural color of the fiber, undyed and 100% traceable.</p>
